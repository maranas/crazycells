...
class MasterViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        let addButton = UIBarButtonItem(barButtonSystemItem: .Add, target: self, action: "changeAnimationMode:")
        ...
        for number in 0...200
        {
            objects.append("This is the number \(number)")
        }
    }
    ...
    func changeAnimationMode(sender: AnyObject?)
    {
