Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   ...
                   DESC
  s.homepage     = "http://i.imgur.com/ujTCzYD.gif", "http://i.imgur.com/QTng17U.gif", "http://i.imgur.com/lGN10st.gif", "http://i.imgur.com/CcHOA0e.gif", "http://i.imgur.com/3jCyfAa.gif", "http://i.imgur.com/YkDy3AG.gif" 
  s.license      = "MIT "
  s.author             = { "Moises" => "moises@ganglionsoftware.com" }
  s.platform     = :ios
  s.source       = { :git => "https://github.com/maranas/crazycells.git", :tag => "1.0" }
  s.source_files  = "crazycells/*.swift"
end
